import numpy as np
from src.mbi import Domain, callbacks, CliqueVector, Factor, LinearMeasurement
from src.mbi import marginal_oracles, marginal_loss, synthetic_data
